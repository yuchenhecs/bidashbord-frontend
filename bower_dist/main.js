...
angular
	.module('biDashboard', requiredModules);
...
function routesConfig($stateProvider) {
  	$stateProvider
		.state('biDashboard', {
			url: '/bi-dashboard',
			template:'<oranj-navigation></oranj-navigation><div layout="vertical" layout-fill class="main-container"><div><div class="title" id="model">Sub-advised Model</div><div class="title"><a href="#" id="build" class="k-link">+ Build Your Own Model</a></div></div><kendo-grid id="grid" options="vm.mainGridOptions" style="clear:left"></kendo-grid><div kendo-window="details" options="vm.windowOptions" style="display:none"><kendo-grid options="vm.detailGridOptions"></kendo-grid></div></div>',
